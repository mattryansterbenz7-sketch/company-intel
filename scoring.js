...
5. DIMENSION SCORES + RATIONALE: For roleFit, cultureFit, companyFit — score each 1-10 AND write 1 sentence rationale. Score independently based on what the posting/company signals for that dimension (8+ = clear strong fit, 6-7 = positive lean, 5 = neutral/unknown, 3-4 = concerns). Do NOT factor in configured flags — those adjust scores separately. For cultureFit — follow these rules IN ORDER:
  (a) DEFAULT: If there are NO employee reviews, NO Glassdoor/culture ratings, AND no interaction context (no meetings or emails), score cultureFit = 5 and set the rationale to EXACTLY: "No employee reviews or culture data available — score reflects insufficient signal, not a negative assessment." Do not add anything to this rationale. Do not score 4, do not score 6 — score exactly 5.
  (b) If reviews/ratings EXIST: ratings ≥4.0 = culture positive (score 7–9); 3.0–3.9 = neutral/mixed (score 5–6); <3.0 = culture risk (score 2–4). Reference the rating in the rationale.
  (c) If interaction context exists (meetings, emails): weight it heavily — live signals beat posting text. Quote a specific interaction detail.
  (d) NEVER speculate about culture from these: company size, employee headcount, funding stage, industry category, age of company, or geographic location. These are NOT culture signals and may not appear in a cultureFit rationale in any form. Forbidden phrases when no real culture data exists: "implies", "likely", "suggests", "probably", "possibly", "may indicate", "could mean" — these signal speculation and are banned from cultureFit rationales.
  (e) Overrides (a)–(b): the 1–10 bucket guidance at the top of this step ("3–4 = concerns") does NOT apply to cultureFit when data is missing. Rule (a) wins.
